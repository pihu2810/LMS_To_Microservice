package com.bridgelabz.BankInfo.aopService;
...
public class AOPService
{
    ...
    @Before("execution(* com.bridgelabz.BankInfo.controller.BankController.*(..))")
    public void logBeforeV1(JoinPoint joinPoint) {
        log.info("Initiating API : " + joinPoint.getSignature().getName() + " ");
    }

    //logs method After hitting API
    @After("execution(* com.bridgelabz.BankInfo.controller.BankController.*(..))")
    ...
    //ExceptionHandling
    @Around(value = "execution(* com.bridgelabz.BankInfo.controller.BankController.*(..))")
