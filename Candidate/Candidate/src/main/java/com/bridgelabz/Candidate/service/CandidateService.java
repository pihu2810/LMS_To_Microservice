...
import com.bridgelabz.Candidate.Util.EmailSenderService;
import com.bridgelabz.Candidate.Util.TokenUtility;
    ...
    public Object insertCandidate(CandidateDTO candidateDTO) {
        ...
        mailService.sendEmail(candidate.getEmail(), "Welcome " + candidate.getFirstName(),
                " Your candidate application submitted successfully!! . Please Click here to get data-> " +
                        "http://localhost:8096/candidateDetails/getByToken/" + token);
        return candidate;
    }
    ...
    public List<CombinedResponseDTO> getAll() {
        ...
        if (getCandidates.isEmpty()) {
            ...
            for (int i = 1; i <= candidateRepository.count(); i++) {
                ...
                Object candidateInfo = restTemplate.getForObject("http://localhost:8096/candidateDetails/get/" + i, Object.class);
                combinedResponseDTO.setCandidate(candidateInfo);
                //        get Qualification details
                Object qualificationInfoList = restTemplate.getForObject("http://localhost:8094/candidateQualification/getby/" + i, Object.class);
                combinedResponseDTO.setQualificationInfoList(qualificationInfoList);
                //        get BankInfo details
                Object bankInfoList = restTemplate.getForObject("http://localhost:8092/bankInfo/get/" + i, Object.class);
...
//        get Candidate details first
        ...
        if (candidate.isPresent()) {
            ...
            //        get Qualification details
            Object qualificationInfoList = restTemplate.getForObject("http://localhost:8094/candidateQualification/getby/" + id, Object.class);
            combinedResponseDTO.setQualificationInfoList(qualificationInfoList);
            System.out.println("Qualification details" + qualificationInfoList);
//        get BankInfo details
            Object bankInfoList = restTemplate.getForObject("http://localhost:8092/bankInfo/get/" + id, Object.class);
            combinedResponseDTO.setBankInfoList(bankInfoList);
    ...
    public List<Candidate> hiredCondidate(String status) {
        ...
        candidateRepository.findCandidateByStatus(status);
        candidate1.getId();
        return candidate;
    }
    ...
    public void deletebyId(long id) {
        ...
        if (candidate.isPresent()) {
            //        get Qualification details
            Object qualificationInfoList = restTemplate.getForObject("http://localhost:8094/candidateQualification/deleteBy/" + id, Object.class);
            //        get BankInfo details
            Object bankInfoList = restTemplate.getForObject("http://localhost:8092/bankInfo/delete/" + id, Object.class);
